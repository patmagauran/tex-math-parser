import {
  create, NodeDependencies, SymbolNodeDependencies, OperatorNodeDependencies, AssignmentNodeDependencies, FunctionNodeDependencies, ConstantNodeDependencies, ArrayNodeDependencies,
} from 'mathjs';

// use BigNumber to reduce floating-point rounding errors
const math = create({
  NodeDependencies, SymbolNodeDependencies, OperatorNodeDependencies, AssignmentNodeDependencies, FunctionNodeDependencies, ConstantNodeDependencies, ArrayNodeDependencies,
});
// import {
//   create, addDependencies,
// } from 'mathjs';
